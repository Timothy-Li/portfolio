    ...
    >
      ...
      <div className="relative w-full overflow-visible flex items-center justify-center">
        <button
          ...
          className={`absolute left-0 z-10 px-6 py-4 text-4xl text-gray-400 font-bold bg-white shadow-md rounded-full transition hover:text-amber-400 disabled:opacity-0 hidden md:block`}
        >
          {"<"}
        </button>
        ...
        <button
          ...
          className={`absolute right-0 z-10 px-6 py-4 text-4xl text-gray-400 font-bold bg-white shadow-md rounded-full transition hover:text-amber-400 disabled:opacity-0 hidden md:block`}
        >
          {">"}
        </button>
      </div>
        ...
        {projects.map((_, idx) => (
          <button
            ...
            className={`w-4 h-4 rounded-full transition-colors ${
              currentSlide === idx ? "bg-gray-300" : "bg-gray-100"
            }`}
          ></button>
        ))}
      </div>
