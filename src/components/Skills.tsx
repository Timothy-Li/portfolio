  ...
  return (
    ...
    >
      <div className="max-w-6xl">
        <h1 className="text-3xl md:text-4xl font-semibold mb-20 text-gray-800">
          Skills
        </h1>
            ...
            <div key={category.title}>
              ...
              <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                {category.skills.map((skill) => (
                  <span
                    key={skill}
                    className="border border-gray-600 text-gray-800 px-4 py-2 rounded-full text-lg md:text-xl
